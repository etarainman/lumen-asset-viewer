...
const Viewer3D = forwardRef<Viewer3DHandle, Viewer3DProps>(({
  ...
  }, [buildings, buildingDefs, activeBuildingId, viewLevel, shellOpacity, statuses, owners, colorMode, colorCodingEnabled, rackDefs, equipmentDefs, showRackLabels, showRMULabels, showEqLabels, showRoof, showSuites, visibleStatuses, selectedRackId, selectedEquipmentId, clashingIds, hiddenLineUps]);
