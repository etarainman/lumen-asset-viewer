          ...
          {!isReadOnly && (
            <div className="pt-2 space-y-3">
              <div className="flex flex-col items-center gap-2">
                <span className="text-[8px] font-black text-slate-500 uppercase tracking-widest self-start px-1">Fine Nudge</span>
                <div className="grid grid-cols-3 gap-1">
                  <div />
                  <button onClick={() => onMove('F')} className="p-2 bg-slate-50 border border-slate-200 rounded-md hover:bg-blue-50 transition-all text-slate-600 flex items-center justify-center"><ArrowUp size={12} /></button>
                  <div />

                  <button onClick={() => onMove('L')} className="p-2 bg-slate-50 border border-slate-200 rounded-md hover:bg-blue-50 transition-all text-slate-600 flex items-center justify-center"><ArrowLeft size={12} /></button>
                  <button onClick={() => onMove('B')} className="p-2 bg-slate-50 border border-slate-200 rounded-md hover:bg-blue-50 transition-all text-slate-600 flex items-center justify-center"><ArrowDown size={12} /></button>
                  <button onClick={() => onMove('R')} className="p-2 bg-slate-50 border border-slate-200 rounded-md hover:bg-blue-50 transition-all text-slate-600 flex items-center justify-center"><ArrowRight size={12} /></button>
                </div>
              </div>
