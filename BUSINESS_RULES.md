...
*   **Header Detection**: The system automatically detects PRO vs. Generic CSVs by scanning headers for keywords:
    *   PRO: `BAY NAME`, `EQUIPMENT NAME`, `RACK ID`, `EQPT ID`.
...
*   **Linking Logic**:
    ...
    *   **Pro-Inventory Master**: The CSV (PRO) is the "Source of Truth" for Asset IDs, Names, and Financial Status.
    *   **Sync Status**:
