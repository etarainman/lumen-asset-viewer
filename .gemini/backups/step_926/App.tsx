...
import {
  ...
  Type, List, Maximize, Maximize2, Map as MapIcon, SlidersHorizontal, ChevronUp, ChevronDown, Check, X, Plus, Cloud, Loader2, Hash, Grid, FileText, AlertCircle
} from 'lucide-react';
...
const App: React.FC = () => {
  ...
  const handleAddRack = useCallback(() => {
    ...
    // Use consistent 3-digit PRO standard padding
    const lineUp = "001";
