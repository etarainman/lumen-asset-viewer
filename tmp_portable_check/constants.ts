...
export const INITIAL_BUILDING_DEFS: BuildingDefinition[] = [
  { 
    ...
    color: '#d2c29d',
    roofColor: '#ffffff',
    svgPath: 'M -800,-600 L 800,-600 L 800,600 L -800,600 Z' 
  },
  { 
    id: 'TYPE_B', 
    name: 'Type B (24 x 12)', 
    ...
    color: '#c2b280',
    roofColor: '#ffffff',
    svgPath: 'M -1200,-600 L 1200,-600 L 1200,600 L -1200,600 Z' 
  },
  { 
    id: 'TYPE_C', 
    name: 'Type C (32 x 12)', 
    ...
    color: '#b2a270',
    roofColor: '#f1f1f1',
    svgPath: 'M -1600,-600 L 1600,-600 L 1600,600 L -1600,600 Z' 
  },
];

export const INITIAL_RACK_DEFS: RackDefinition[] = [
  { id: 'RACK_42U', name: 'Standard 42U Cabinet', totalU: 42, width: 600, depth: 1070, height: 2000, color: '#1e293b' },
  { id: 'RACK_48U', name: 'High-Density 48U', totalU: 48, width: 600, depth: 1200, height: 2200, color: '#0f172a' },
  { id: 'RACK_2POST', name: '2-Post Relay Rack', totalU: 45, width: 482, depth: 400, height: 2130, color: '#475569' },
];

export const INITIAL_EQUIPMENT_DEFS: EquipmentDefinition[] = [
  { id: 'EQ_SERVER_1U', name: 'Generic 1U Server', heightU: 1, depth: 750, powerWatts: 450, color: '#3b82f6', category: 'SERVER' },
  { id: 'EQ_SERVER_2U', name: 'Dual-Node 2U Server', heightU: 2, depth: 800, powerWatts: 1200, color: '#6366f1', category: 'SERVER' },
  { id: 'EQ_SWITCH_1U', name: '48-Port Edge Switch', heightU: 1, depth: 350, powerWatts: 150, color: '#06b6d4', category: 'NETWORK' },
  { id: 'EQ_STORAGE_4U', name: '60-Bay Storage Array', heightU: 4, depth: 950, powerWatts: 2400, color: '#14b8a6', category: 'STORAGE' },
  { id: 'EQ_PATCH_1U', name: '24-Port Patch Panel', heightU: 1, depth: 50, powerWatts: 0, color: '#94a3b8', category: 'PATCH_PANEL' },
];
