...
const SitePlanner2D: React.FC<SitePlanner2DProps> = ({
  buildings, buildingDefs, selectedBuildingId, appMode, colorMode, colorCodingEnabled, onSelectBuilding, onUpdateBuilding, onAddBuilding, statuses, owners, isDirty, isSaving, saveSuccess, onSave, onDeleteBuilding, onEnterBuilding, showLabels, visibleStatuses = Object.values(Status4D)
}) => {
