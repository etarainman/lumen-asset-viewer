...
const Viewer3D = forwardRef<Viewer3DHandle, Viewer3DProps>(({
  ...
  useEffect(() => {
    ...
    const handleClick = (event: MouseEvent) => {
      ...
      if (!event.ctrlKey) return; // Enforce CTRL+Click for selection
      ...
      // Removed background de-selection (Lines 413-416 removed)
    };
        ...
        b.racks
          ...
          .forEach(rack => {
            ...
            rackEquipment.forEach(eq => {
              ...
              // Position inside rack (Aligned Front)
              // Front of Rack is +z/2. Front of Eq is pos.z + d/2.
              // pos.z + d/2 = R/2 => pos.z = (R - d) / 2
