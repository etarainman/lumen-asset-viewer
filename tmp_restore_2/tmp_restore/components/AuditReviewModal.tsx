    ...
    const runAnalysis = async () => {
      try {
        ...
        const prompt = `
          ...
          3. Recommendation for the Granite DB administrator.
            ...
            <div className="mt-6 p-4 bg-amber-50 rounded-xl border border-amber-100 flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-[11px] text-amber-700 leading-tight">
                  {summary.mismatchCount} items have physical labels that conflict with their Granite records. These must be updated in the source database via the Instructions File.
                </p>
              </div>
            </div>
          )}
