        ...
        <div className="flex-1 overflow-hidden flex flex-col p-8">
          <div className="bg-blue-50 border border-blue-100 p-4 rounded-xl mb-6 flex items-start gap-3">
            ...
            <p className="text-sm text-blue-800 leading-relaxed">
              The following items have been <strong>Verified</strong> during this audit. Review the mapping below. Clicking "Download CSV" will generate the <strong>Instructions File</strong> for the Granite Database reconciliation team.
            </p>
          </div>
            ...
            <table className="w-full text-left border-collapse">
              <thead className="sticky top-0 bg-slate-50 z-10 border-b border-slate-200">
                <tr className="text-[10px] font-black text-slate-400 uppercase tracking-tighter">
                  ...
                  <th className="px-4 py-3">Granite ID</th>
